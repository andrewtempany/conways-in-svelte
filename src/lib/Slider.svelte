<script>
  ...
  <style>
    ...
    .range__track {
      height: 6px;
      background-color: var(--track-bgcolor, rgba(255, 255,255,0.25));
      border-radius: 999px;
    }
    ...
    .range__tooltip {
      ...
      border-radius: 4px;
      text-align: center;
      background-color: var(--tooltip-bgcolor, rgba(255,255,255,0.25));
      background: var(--tooltip-bg, rgba(255,255,255,0.25));
      /* linear-gradient(45deg, rgba(255,255,255,0.25), rgba(255,255,255,0.4)); */
    }
